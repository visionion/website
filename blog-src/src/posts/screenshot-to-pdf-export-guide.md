---
title: "Screenshot to PDF: Complete Guide to Exporting and Sharing"
description: Learn how to convert screenshots to PDF format. From single images to multi-page documents, master the screenshot-to-PDF workflow.
date: 2024-11-25
category: snapp
---
...
3. Click the PDF dropdown in the lower left
...
1. Open the image in Photos or another viewer
2. Press Ctrl+P to print
3. Select "Microsoft Print to PDF" as the printer
4. Click Print and choose your save location
...
1. Convert each screenshot to PDF
2. Use a PDF editor to combine them
3. Add page numbers, headers if needed
