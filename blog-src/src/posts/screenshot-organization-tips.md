---
title: "Screenshot Organization: Keeping Your Captures Tidy"
description: Learn how to organize your screenshots effectively. From naming conventions to folder structures, master screenshot management.
date: 2024-11-10
category: snapp
---
...
- `project-subject-detail.png`
- `YYYY-MM-DD-description.png`
- `client-project-version.png`
...
1. Create a new organized folder structure
2. Move everything old to an "unsorted-archive" folder
3. Start using your new system immediately
4. Sort old screenshots gradually, or keep the archive as-is and let time make it irrelevant
